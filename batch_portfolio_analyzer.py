...
class BatchPortfolioAnalyzer:
        ...
        for symbol in symbols:
            try:
                ...
                if 'error' not in market_data:
                    ...
                    print(f"    📊 {symbol}: ${market_data.get('current_price', 'N/A')}")
                else:
    ...
    def _save_to_csv(self, results: List[Dict[str, Any]], errors: List[Dict[str, Any]], file_path: str):
        """保存结果到CSV文件"""
    ...
    def _save_to_json(self, results: List[Dict[str, Any]], errors: List[Dict[str, Any]], file_path: str):
        """保存结果到JSON文件"""
        output_data = {
